...
% Last Modified by GUIDE v2.5 22-Jan-2019 05:57:36
...
uitable = readtable(DataAgesortir1Fix100);
...
% --- Executes on button press in pushbuttoncoba.
function pushbuttoncoba_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttoncoba (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
klasifikasi
